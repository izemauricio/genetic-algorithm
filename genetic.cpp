...
void evolve()
{
	...
	// i vai ser igual a metade se todos foram menores que a media OOOOU i vai ser igual aos copiados (com isso, s� os individuos da populacao total que nao foram qualificados irao receber crossover)
	i = j;
